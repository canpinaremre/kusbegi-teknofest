...
def show_camera():
    ...
    cap = cv2.VideoCapture(
        'udpsrc port=5700 \
            ! application/x-rtp, payload=96 ! rtph264depay \
                ! h264parse ! avdec_h264 ! decodebin ! videoconvert \
...
MISSION_ALTITUDE_RED = -5 #After pool
...
drone.mode_takeoff(MISSION_ALTITUDE) 
